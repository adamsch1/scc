...
/**** The DDJ Listing is continuous, but delineated ****/
/****  as to separate files, next is CC1.C ****/

/***	Get the remainder of the compiler	***/
/** This current file is named CC0.C  **/
/** #include cc1.c **/
/** #include cc2.c **/
/** #include cc3.c **/
/** #include cc4.c **/
...
/** For Reference, below is how the 'code works' version is **/
/** #include C86N-0.C  **/
/** #include C86N-1.C  **/
/** #include C86N-2.C  **/
/** #include C86N-3.C  **/
...
main()
	...
	dumplits();		/* then dump literal pool */ /** added back in **/
	dumpglbs();		/* and all static memory */
	errorsummary();		/* summarize errors */ /** original place, added back in */
