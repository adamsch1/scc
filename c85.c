...
int	nxtlab,		/* next avail label # */
	...
	saveout,	/* holds output ptr when div2erted to console	   */
			/*					gtf 7/16/80 */
...
closeout()
{
	tofile();	/* if div2erted, return to file */
...
/* Below are functions to emit asm */
/*	>>>>>> start of cc8 <<<<<<<	*/
...
/* Compute remainder (mod) of secondary register div2ided */
/*	by the primary */
